<!-- Typing SVG -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=1E90FF&center=true&vCenter=true&width=600&lines=Hi%2C+I'm+Lakshya+Kumar+%F0%9F%91%8B;Full-Stack+Developer+%7C+ECE+Engineer;AI+%26+System+Design+Enthusiast;Building+Smart+%26+Scalable+Applications" alt="Typing SVG" />
</p>

---

# 👨‍💻 About Me  
- 🎓 B.Tech in **Electronics & Communication Engineering** at **IIIT Una**  
- 💡 Passionate about **Spring Boot, React, Microservices, and AI-driven systems**  
- 🛠️ Experience building **secure, scalable, real-time backend systems**  
- 🤖 Worked extensively with **Gemini API, REST APIs, Redis, MongoDB, Keycloak, RabbitMQ**  
- 🏗️ Love building **automation tools, backend-heavy platforms, and microservice architectures**  
- 🏀 Silver Medalist (2×) in Inter-IIIT Basketball Tournament  
...
✨ Always exploring new technologies, building impactful projects, and open to collaborations!
